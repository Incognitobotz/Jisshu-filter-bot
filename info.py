...
BOT_TOKEN = environ.get('BOT_TOKEN', '6624184873:AAEfowQ56REXMXrjyJQsBWe4otsT3Mwn93Y')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7293915683').split()]
USERNAME = environ.get('USERNAME', "https://t.me/BarkesyaXboy") # ADMIN USERNAME
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001931651573').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001931651573')
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001931651573')) # 
...
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/JpMovies_Official/104")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/JpMovies_Official/104")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "bce801b059c63f4264e80e61cb59c7f61fd8ca5c")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'seturl.in')
SHORTENER_API2 = environ.get("SHORTENER_API2", "bce801b059c63f4264e80e61cb59c7f61fd8ca5c")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'seturl.in')
SHORTENER_API3 = environ.get("SHORTENER_API3", "bce801b059c63f4264e80e61cb59c7f61fd8ca5c")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://telegra.ph/file/6b7b9ad68790aa63df872.jpg')).split()
